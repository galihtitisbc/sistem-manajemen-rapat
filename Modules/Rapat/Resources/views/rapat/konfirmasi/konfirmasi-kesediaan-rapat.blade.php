        ...
        <div class="container mt--8 pb-7">
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-7">
                    <div class="card">
                        <div class="card-body">
                            <i class="fas fa-question fa-lg" style="color: #FFD43B;"></i>
                            <form action="/submit-kesediaan" method="POST">

                                <!-- Detail Rapat (Hanya Teks) -->
                                <div>
                                    <label class="section-label">Agenda Rapat:</label>
                                    <div class="section-content">Evaluasi Proyek Semester Genap</div>

                                    <label class="section-label">Waktu:</label>
                                    <div class="section-content">Senin, 12 Mei 2025 | 09.00 - 11.00</div>

                                    <label class="section-label">Tempat:</label>
                                    <div class="section-content">Ruang Rapat 1, Gedung A</div>
                                </div>
